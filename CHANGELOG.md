...
## [2.3.0](https://github.com/lpchaim/nixos/compare/v2.2.0...v2.3.0) (2026-08-09)


### Features

* Add agenix-rekey flake schema ([5e8416b](https://github.com/lpchaim/nixos/commit/5e8416b4b7903c30daa562d9ceba871923a70f00))
* Add basic default mime type sources ([1dc259c](https://github.com/lpchaim/nixos/commit/1dc259c11ebdf8f68c49c4c356acd5d5a52c6d17))
* Add default NetworkManager priorities for ethernet and wifi ([905f490](https://github.com/lpchaim/nixos/commit/905f49021d43b90ba17cc7726150acc241c602ad))
* Add freesmlauncher ([e6c94df](https://github.com/lpchaim/nixos/commit/e6c94df98d9825b6c6cb77015de8dbf5f45be6d3))
* Add gui.imageEditors home module ([df1cc19](https://github.com/lpchaim/nixos/commit/df1cc1957c0e14a30aab9ba39d3a9fc33c0b6826))
* Add headless, server profiles, more granular profiles ([5b91bba](https://github.com/lpchaim/nixos/commit/5b91bbaa216d41b742ea30f9f54bae243e7d2921))
* Add hyprland bindings for play/previous/next media keys ([0af2ef1](https://github.com/lpchaim/nixos/commit/0af2ef1b2db47cc7e86c4d1e020bd31f2c0b2da7))
...
* Add nixtests to flake checks ([6b5500a](https://github.com/lpchaim/nixos/commit/6b5500a93738b50e9b5b1cbd7e1dcf5c63121d0d))
* Add vars.networking, advertise routes on tailscale for servers ([ab7701e](https://github.com/lpchaim/nixos/commit/ab7701ec708e603cfd8223e081e3d19925a7f20a))
* Add zen browser ([0e65f04](https://github.com/lpchaim/nixos/commit/0e65f042cfec2b92e104b0abea29f25d95e9a37d))
...
* Change OCI backend to podman, enable on desktop and laptop ([fec835d](https://github.com/lpchaim/nixos/commit/fec835d39ea9a9111a1961a74549bc8b95792df6))
...
* **cli.editors.neovim:** Misc plugin tweaks ([c2bb94b](https://github.com/lpchaim/nixos/commit/c2bb94b9231e6867d4eaf209d47b99477ea33f7b))
* **cli.editors:** Revive neovim config, enable by default ([3e09872](https://github.com/lpchaim/nixos/commit/3e0987202328cb3677337d2156878190d3dc82d5))
* **cli.extras:** Add freeze for cli screenshot generation ([e4dd0fa](https://github.com/lpchaim/nixos/commit/e4dd0fae1a91783179f6d4284d641d03e538ce4c))
* Dedicated keymaps module for nvim, WIP helix-like bindings ([3e74a46](https://github.com/lpchaim/nixos/commit/3e74a462b00330a028d6d86aae8445041ee71385))
* Disable fish/man completions and scripts for servers ([1b3feda](https://github.com/lpchaim/nixos/commit/1b3feda8d4a50a4c4c314ccdc417dbce8b5bd1e2))
...
* Enable syncthing on raspberrypi, misc improvements ([6b85730](https://github.com/lpchaim/nixos/commit/6b857302d53f50664d83900e16da33cba509b1b5))
* Experimental native docker-lock ([50cc370](https://github.com/lpchaim/nixos/commit/50cc370f24a6ebef7091fd203b90627aa590a1e9))
* Initial colmena implementation ([29adf00](https://github.com/lpchaim/nixos/commit/29adf00e7c18e02898e6b00079cf9b3efeed0b27))
* Initial OCI virtualization options ([02bc2e1](https://github.com/lpchaim/nixos/commit/02bc2e1cd2dac6319c738d75d2c6d38734b7ef2b))
* IP info on var.hosts, better known hosts file ([faab682](https://github.com/lpchaim/nixos/commit/faab682f8c3f2332778fc0357062ddf24f5338fa))
* **just:** Better just secrets module ([1d57096](https://github.com/lpchaim/nixos/commit/1d5709682cc74f5c41488e1542cdea7ea53c69e8))
* More solid substituters, expose nix settings on flake ([0c2f00e](https://github.com/lpchaim/nixos/commit/0c2f00e81c248c9b49e14a2fc3cfc338811cdf06))
* **neovim:** Add custom animotion plugin ([adc69ea](https://github.com/lpchaim/nixos/commit/adc69ea3aa402077f397c184386b62943be3c5a9))
* **neovim:** Tweak indent-blankline, treesitter settings ([ca891af](https://github.com/lpchaim/nixos/commit/ca891afe3d6805c5b181b7bfedacf1e42d053375))
* Networking module revamp ([847f501](https://github.com/lpchaim/nixos/commit/847f501472caacf22ce20cf4851cc38c6e30c596))
* NixOS services module refactor, WIP home assistant service ([51ce29f](https://github.com/lpchaim/nixos/commit/51ce29fbda0af219da69656513cc8415c9247565))
* **nixos:** Add storage module ([1efccb3](https://github.com/lpchaim/nixos/commit/1efccb396fda1995ef9f852c0482e61321096196))
* **obsidian:** Use home manager program for obsidian ([5997464](https://github.com/lpchaim/nixos/commit/59974646bd1e8310dcfa5ceeaaf2e482190b2428))
* Overlay patched termshot to support custom fonts ([2081b78](https://github.com/lpchaim/nixos/commit/2081b788a3b1f5fdb3a5dcdf00fc88e2cbe959a7))
* Prettier just test output ([b86d546](https://github.com/lpchaim/nixos/commit/b86d546bbf19a9bf5333df7612734772d32af9b4))
* Refactor lib.config to vars ([7b160f5](https://github.com/lpchaim/nixos/commit/7b160f5323bbcda70a4a9768f7c451486970b15b))
* Remove unnecessary podman user definition ([314cec9](https://github.com/lpchaim/nixos/commit/314cec9329b403ce54a28407adc9c38dd3fa6949))
* Server features ([9d94aba](https://github.com/lpchaim/nixos/commit/9d94aba4e2e88deb923aadc305856eaa9703343e))
* Set sans-serif and serif fonts ([050e285](https://github.com/lpchaim/nixos/commit/050e2859c06bb7a07122947a7731dde3a79516c3))
* Split gnome and gdm profiles ([3d43e99](https://github.com/lpchaim/nixos/commit/3d43e9965096e3c5c2c4cc8b0144739a810b9291))
* SSH keypair generator, yubikey secrets + pubkey ([980adad](https://github.com/lpchaim/nixos/commit/980adad9474dd899056d223824cafd6f5b4af4b1))
* **ssh:** Use setEnv to fix TERM env var issues ([3a4f873](https://github.com/lpchaim/nixos/commit/3a4f8732d5e98ba96b85fadb23db1c6a9cf1387c))
* Syncthing GUI user + password, defaults, add steamdeck-standalone ([6e17eab](https://github.com/lpchaim/nixos/commit/6e17eabdeedec6e71a720f22716fca3d2223fce2))
* **syncthing:** Migrate syncthing to home configuration ([020f617](https://github.com/lpchaim/nixos/commit/020f617c6ed710d372a9fc90e33720d8fc3b2b4b))
* **tests:** Add age pubkey snapshot, ensure servers have authorized keys ([2b217b7](https://github.com/lpchaim/nixos/commit/2b217b71f1f3775069092f1c9a7ae313fada24b8))
* **tests:** Implement nixtest, initial snapshot tests ([8a7e0f6](https://github.com/lpchaim/nixos/commit/8a7e0f6c1dac827ee3ee260655ef006a187b3bd2))
* Update inputs, fix custom nushell writers, init hyfetch ([518c597](https://github.com/lpchaim/nixos/commit/518c597a627828d18037d89b700b4624956f16f4))


### Bug Fixes

* Atuin secrets ([e117172](https://github.com/lpchaim/nixos/commit/e11717280a598bd8f673e5326692e00d1d3e8c96))
* Authorized keys ([c22f30c](https://github.com/lpchaim/nixos/commit/c22f30c68d58abf394f9e782b04c7f77984df019))
* Bar enabled on non graphical config, nixd always enabled ([30f5b2b](https://github.com/lpchaim/nixos/commit/30f5b2ba99dcd8f1eec5edb5e4f346bb43949496))
...
* Disable more undesired non-graphical packages ([314b128](https://github.com/lpchaim/nixos/commit/314b12826f1af2bf9034fb9d8d5050cab97e0ec2))
* Disable syncthing tray by default, misc small fixes ([3b0693e](https://github.com/lpchaim/nixos/commit/3b0693ecb6e1de5dd8488efff6fc8f91e1b44383))
* Enable acpid, upower by default ([5c36017](https://github.com/lpchaim/nixos/commit/5c3601792aed6ab82a5a41cbdbaf4f77bf55fd3e))
* GHA nix commands ([c321532](https://github.com/lpchaim/nixos/commit/c321532f58f49dee323cbeacd306f853d1ec7c74))
...
* New tailscale key with permission to assign all existing tags ([10fa2c9](https://github.com/lpchaim/nixos/commit/10fa2c9b29fba8239338f3d4e0b7a0564148380c))
* Raspberry pi config, update inputs ([789d50b](https://github.com/lpchaim/nixos/commit/789d50b41a5ce6004e8840754687266f7532a995))
* Remove dangling flakeModule ([7911c86](https://github.com/lpchaim/nixos/commit/7911c86883b60ca012ab5a7fb8158ef1d4fe4e9b))
* Set users.podman.isSystemUser ([971dacc](https://github.com/lpchaim/nixos/commit/971daccca27e26ff918b563cb1d38774a2e37aeb))
* **ssh:** Add id_ed25519 identity ([b4351ba](https://github.com/lpchaim/nixos/commit/b4351ba205ae4dd9f8647620a166f7c16667ba3e))
* **ssh:** Add new tangled domain ([8699c6b](https://github.com/lpchaim/nixos/commit/8699c6bf7d5bd4f5fa95cf8f2c85df1dc19a7a6f))
* **ssh:** Clean up identities, fix host-specific matchers ([9301739](https://github.com/lpchaim/nixos/commit/93017390a2cead95484674e60e3cc3cdcb45ecc8))
* **ssh:** Fix tangled's domain ([4869b98](https://github.com/lpchaim/nixos/commit/4869b98c6ae309d2b215e3ee6a7ec87411d62a0f))
* **tailscale:** Misc tailscale fixes ([58eef73](https://github.com/lpchaim/nixos/commit/58eef73062181e1c37d08308b4e9931a26c58a9f))
* u2f auth file actually works again, now only requires pin for sudo ([f5c0a14](https://github.com/lpchaim/nixos/commit/f5c0a14f4c94c514423f5679596e2cee7990223e))
* **u2f:** Disable u2f auth on login ([a1f36a6](https://github.com/lpchaim/nixos/commit/a1f36a6d687411dc524dbdbb600afb62aee2f730))
* Update deprecated documentation.man.generateCaches ([b20ddb8](https://github.com/lpchaim/nixos/commit/b20ddb8f3c9bcf269d33c45bc3feb14eec89a2ff))
* Update desktop pubkey snapshot ([ce43537](https://github.com/lpchaim/nixos/commit/ce435379396740a0ab499825b15facd369aef57f))
